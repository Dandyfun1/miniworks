...
function handleFiles(files){for(let file of files){const url=URL.createObjectURL(file); addFileCard(file.name,url,file.type);}}
...
document.getElementById("addDoc").onclick=()=>{
  ...
  iframe.src=link; iframe.width="100%"; iframe.height="300";
